 ...
 */
    static RETURN_CODE speech_get_token(const char *api_key,
 ...
 * @return RETURN_OK 成功 其它失败
 */
    static RETURN_CODE parse_token(const char *response, const char *scope, char *token);
 ...
 * @return
 */
    static RETURN_CODE obtain_json_str(const char *json, const char *key, char *value, int value_size);
